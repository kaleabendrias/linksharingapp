...
import { FaArrowRight, FaGithub, FaTwitter, FaLinkedin, FaGlobe } from "react-icons/fa";
        ...
        <div className="p-6">
          {formData.links.map((link) => (
            <a
              href={link.link}
              key={link.id}
              className={`flex items-center justify-between p-3 mb-3 rounded-md ${getBackgroundColor(link.platform)}`}
              target="_blank"
